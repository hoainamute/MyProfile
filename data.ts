...
export const profileData: ProfileData = {
  ...
  email: "namnh@hoainam.me",
  github: "https://github.com/namhoainguyen",
  linkedin: "https://www.linkedin.com/in/namhoainguyen/",
  about: "Tôi là một kỹ sư phần mềm với tư duy hướng giải pháp, tập trung vào việc tạo ra các ứng dụng web mượt mà và dễ bảo trì. Với kinh nghiệm dày dặn trong hệ sinh thái JavaScript/TypeScript, tôi không chỉ viết mã mà còn chú trọng vào kiến trúc phần mềm, quy trình phát triển và trải nghiệm người dùng cuối. Tôi cũng là một diễn giả tích cực tại các sự kiện công nghệ, chia sẻ kiến thức về React, Performance và Engineering Culture.",
