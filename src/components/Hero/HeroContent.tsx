...
const HeroContent: React.FC<HeroContentProps> = ({ data }) => {
  return (
    <div className="flex flex-col justify-center">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <a
          ...
          className="px-8 py-3 border-2 border-indigo-600 text-indigo-600 dark:text-indigo-400 dark:border-indigo-400 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors font-semibold"
        >
          Get in Touch
        </a>
      </div>
